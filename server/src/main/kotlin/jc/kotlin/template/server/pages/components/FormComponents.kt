    ...
    div {
        ...
        form {
            ...
            div {
                ...
                div {
                    classes = setOf("flex", "flex-row", "gap-3")
                    ...
                    div {
                        ...
                        label {
                            classes =
                                radioLabelStyles + setOf("peer-checked:bg-yellow-100", "peer-checked:border-yellow-400")
                    ...
                    div {
                        ...
                        label {
                            classes = radioLabelStyles + setOf("peer-checked:bg-red-100", "peer-checked:border-red-400")
                    ...
                    div {
                        ...
                        label {
                            classes =
                                radioLabelStyles + setOf("peer-checked:bg-blue-100", "peer-checked:border-blue-400")
